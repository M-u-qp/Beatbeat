package com.muqp.feature_search.presentation.screen.genre_search
...
import com.muqp.beatbeat.search.databinding.FragmentGenreSearchBinding
...
class GenreSearchFragment : Fragment() {

    private var _binding: FragmentGenreSearchBinding? = null
    private val binding get() = _binding!!

    private lateinit var viewModelFactory: ViewModelProvider.Factory
    private val viewModel: GenreSearchViewModel by viewModels { viewModelFactory }
    ...
    override fun onCreateView(
        ...
        _binding = FragmentGenreSearchBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun initListeners() = with(binding) {
        genreSearchTracksRv.layoutManager = LinearLayoutManager(context)
        genreSearchTracksRv.adapter = trackAdapter

        navigationDataString?.let {
            viewModel.loadSearchResultToTrack(it)
            genreSearchTitleTv.text = it
        }
            ...
            viewLifecycleOwner.repeatOnLifecycle(Lifecycle.State.STARTED) {
                viewModel.state.collectLatest { pagingData ->
                    if (pagingData != null) {
                        ...
                        trackAdapter.submitData(pagingTrackList)
                    }
                }
            }
        }
                            ...
                            viewModel.playlists.collect { playlists ->
                                ...
                                PlaylistSelectionDialog(
                                    ...
                                    onCreatePlaylistClicked = {
                                        navigate(
                                            actionId = R.id.action_genreSearchFragment_to_favoritesFragment,
